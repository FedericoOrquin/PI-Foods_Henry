...
export default function Filters({setCurrentPage, setOrder,diets, setIsActive}) {
    ...
    return (
        <div className="filterContainer">
            <button onClick={e => handleClick(e)} className="button">Clear filters</button>
            <select name="" id="" value={sort} className="filter" onChange={e=>handleSort(e)}>
                <option hidden> Sort recipes</option>
                <option value='asc'>Ascendant A-Z</option>
                <option value='desc'>Descendant Z-A</option>
            </select>
            <select name="" id="" value={sort} className="filter" onChange={e=>handleSort(e)}>
                <option hidden> Sort by HealthScore</option>
                <option value='ascH'>Ascendant HealthScore</option>
                <option value='descH'>Descendant HealthScore</option>
            </select>
            <select name="" id="" className="filter" value={filter} onChange={e=>handleFilterDiet(e)}>
            ...
            <select value={filterO} onChange={e=>handleFilterOrigin(e)} className="filter" >
